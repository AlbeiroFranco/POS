...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=.\\SQLEXPRESS;Database=POS;TrustServerCertificate=true;User Id=sa; Password=Sinco123;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<BranchOffice>(entity =>
        {
            entity.HasKey(e => e.BranchOfficeId).HasName("PK__BranchOf__27247FF918251112");
        ...
        {
            entity.HasKey(e => e.BusinessId).HasName("PK__Business__F1EAA36E33078112");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Categori__19093A0B83187C7F");
        ...
        {
            entity.HasKey(e => e.ClientId).HasName("PK__Clients__E67E1A249E7034D8");
        ...
        {
            entity.HasKey(e => e.DepartmentId).HasName("PK__Departme__B2079BED01909A4C");
        ...
        {
            entity.HasKey(e => e.DistrictId).HasName("PK__District__85FDA4C6AE7B7824");
        ...
        {
            entity.HasKey(e => e.DocumentTypeId).HasName("PK__Document__DBA390E15FD59CA9");
        ...
        {
            entity.HasKey(e => e.MenuId).HasName("PK__Menus__C99ED230DFD0E55F");
        ...
        {
            entity.HasKey(e => e.MenuRolId).HasName("PK__MenuRole__6640AD0CD50231E6");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__B40CC6CDB7CB49C1");
        ...
        {
            entity.HasKey(e => e.ProviderId).HasName("PK__Provider__B54C687DCD782F67");
        ...
        {
            entity.HasKey(e => e.ProvinceId).HasName("PK__Province__FD0A6F833AC9D697");
        ...
        {
            entity.HasKey(e => e.PurcharseId).HasName("PK__Purchars__A98C674BFE69F4DB");
        ...
        {
            entity.HasKey(e => e.PurcharseDetailId).HasName("PK__Purchars__7353248B00DFA1E4");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Roles__8AFACE1A2FA5B646");
        ...
        {
            entity.HasKey(e => e.SaleId).HasName("PK__Sales__1EE3C3FF34286E53");
        ...
        {
            entity.HasKey(e => e.SaleDetailId).HasName("PK__SaleDeta__70DB14FE5A1F465F");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CC4C61902DF2");
        ...
        {
            entity.HasKey(e => e.UserRoleId).HasName("PK__UserRole__3D978A359438CB94");
        ...
        {
            entity.HasKey(e => e.UserBranchOfficeId).HasName("PK__UsersBra__7D1E804A9C9C4386");
